...
def multiply_matrices():
    ...
    result_label.config(text="Result Column Vector: {}".format(result_vector))
...
window = tk.Tk()
window.title("Matrix-Column Vector Multiplication")

# Vector input
label_vector = tk.Label(window, text="X value")
label_vector.grid(row=0, column=0)
label_vector2 = tk.Label(window, text="Y value")
label_vector2.grid(row=1, column=0)
entry_vector = tk.Entry(window)
entry_vector.grid(row=0, column=1)
